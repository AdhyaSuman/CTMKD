...
class CTM(AbstractModel):
    ...
    def __init__(self, num_topics=10, model_type='prodLDA', activation='softplus',
                 ...
                 use_partitions=True, use_validation=True, num_samples=10,
        ...
        self.hyperparameters['hidden_sizes'] = CTM.set_hiddensize(hidden_sizes, num_neurons, num_layers)
    ...
    def set_hiddensize(hidden_sizes=None, num_neurons=None, num_layers=None):
        ...
        elif (num_layers and num_neurons) == None:
            if hidden_sizes == None:
                # raise Exception('Either "hidden_sizes" or ("num_neurons", "num_layers") should be given')
                H_SIZES=None
            else:
                H_SIZES = hidden_sizes
        return H_SIZES
    ...
    def train_model(self, dataset, hyperparameters=None, top_words=10, save_dir=None):
        ...
        if self.use_partitions and self.use_validation:
            ...
            self.model.fit(x_train, x_valid, verbose=True, save_dir=save_dir, texts = train)
        ...
        self.model.fit(x_train, None, verbose=True, save_dir=save_dir, texts = dataset.get_corpus())
    ...
    def set_params(self, hyperparameters):
        for k in hyperparameters.keys():
            ...
            self.hyperparameters['hidden_sizes'] = CTM.set_hiddensize(self.hyperparameters['hidden_sizes'], self.hyperparameters['num_neurons'], self.hyperparameters['num_layers'])
