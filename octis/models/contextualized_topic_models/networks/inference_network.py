...
class ContextualInferenceNetwork(nn.Module):
    ...
    def __init__(self, input_size, bert_size, output_size,
        ...
        self.f_mu = nn.Linear(input_size, output_size)
        self.f_mu_batchnorm = nn.BatchNorm1d(output_size, affine=False)

        self.f_sigma = nn.Linear(input_size, output_size)
